...
#SBATCH --output=fsdp_%j.out                # Standard output log file
#SBATCH --error=fsdp_%j.err                 # Standard error log file
...
srun torchrun \
  ...
  --lr 5e-5 \
  --bf16 \
  --output_dir "$SCRATCH/outputs/fsdp"
